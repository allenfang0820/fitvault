...
V2.0 是自 V1.2.0 以来的一次大版本升级。

### 重点新增

- **运动生涯系统**：新增生涯概览、多运动记录中心、赛事档案、赛季、时间线、足迹地图、赛事相册和年度 AI 总结。
- **活动详情与复盘**：升级多运动概览，重做复盘工作台，新增分层曲线、事件标记、状态阶段、地形负荷和 AI 洞察。
- **力量训练肌肉热力图**：解析 FIT 中的结构化动作与训练组，新增前后人体肌群热力图、动作组表和双向联动。
- **轨迹分析真实地形**：轨迹分析工具增加真实地形图层，山地、越野和爬坡路线可直观呈现地形起伏，并保留标准地形回退。
- **账号连接中心**：统一管理 Garmin 和 COROS 连接、授权、活动同步与用户画像更新。
